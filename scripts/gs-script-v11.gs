...
function getEnrichmentForRow_(row, lookupMap) {
  ...
  // Installed PLA ID: normalize first token
...
function normalizeInstalledPlaLookupKey_(v) {
  ...
  // Conservative: extract first PLA-like token from common delimiters
